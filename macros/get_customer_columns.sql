...
{% set columns = [
    ...
    {"name": "ar_account_id", "datatype": dbt_utils.type_int()},
    {"name": "balance", "datatype": dbt_utils.type_float()},
    {"name": "balance_with_jobs", "datatype": dbt_utils.type_float()},
    {"name": "bill_address_id", "datatype": dbt_utils.type_int()},
    ...
    {"name": "default_tax_code_id", "datatype": dbt_utils.type_int()},
    ...
    {"name": "tax_exemption_reason_id", "datatype": dbt_utils.type_int()},
