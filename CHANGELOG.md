...
## 🎉 Feature Updates 🎉
- Addition of the new `stg_quickbooks__credit_card_payment_txn` model that may be used to track credit card transactions within QBO and used in downstream financial statement reports.
